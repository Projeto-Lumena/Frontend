...
<template>
    <header class="hidden md:block fixed z-50 top-0 left-0 w-full bg-[#0C2645] p-8">
    ...
    <div class="md:hidden fixed bottom-0 left-0 z-50 w-full h-20 bg-[#0C2645] shadow-[0_-4px_15px_rgba(0,0,0,0.15)]">
        <ul class="h-full flex items-center justify-around">
            <li class="h-full flex-1">
                <RouterLink to="/" class="h-full flex flex-col items-center justify-center gap-1 text-white"
            ...
            <li class="h-full flex-1">
                <RouterLink :to="authStore.isAuthenticated ? '/perfil' : '/login'"
                    class="h-full flex flex-col items-center justify-center gap-1 text-white"
                    active-class="text-[#FDA202]">
            ...
            <li class="h-full flex-1">
                <RouterLink to="/sacola" class="h-full flex flex-col items-center justify-center gap-1 text-white"
                    active-class="text-[#FDA202]">
